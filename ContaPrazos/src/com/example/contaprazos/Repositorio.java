...
import com.example.contaprazos.Processo.Processos;
import com.example.contaprazos.Usuario.Usuarios;
...
public class Repositorio {
	...
	//-----------------------------------------------------------------------------//
	/*
	public ObjRasProd buscarRasProd(long _idrasprod) {
		// select * from objeto where _id=?
		Cursor c = db.query(true, NOME_TABELA_5, ObjRasProd.colunas, RasProdutos._IDRASPROD + "=" + _idrasprod, null, null, null, null, null);
